...
export default function TopBar({ isCollapsed, onToggleCollapse, onOpenMobile, isMobile }: TopBarProps) {
    ...
    const handleDbClick = () => {
        if (isGuest) {
            // Guests cannot connect a DB — send them to register
    ...
    return (
        <header style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                {/* DB status pill — shows "Guest Mode" for unauthenticated users */}
                {isGuest ? (
                    <button
                        onClick={handleDbClick}
                        title="Sign in to connect your own database"
                        style={{
                    ...
                    >
                        {/* Lock icon */}
                        <svg width="10" height="10" fill="none" stroke="#818cf8" strokeWidth="2.5" viewBox="0 0 24 24" style={{ flexShrink: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                {/* Sign In / Register links for guests */}
                {isGuest && (
